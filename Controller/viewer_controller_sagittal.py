...
class ViewerControllerSagittal:
    """
    ...
    def load_dicom_folder(self, folder):
        if self.slider_container is not None:
    ...
    def update_display(self):
        ...
        sagittal_img = process_layers(self.volume_layers, self.slice_index, view_type="sagittal")

        h, w = sagittal_img.shape
        qimage = QImage(sagittal_img.data, w, h, w, QImage.Format.Format_Grayscale8)
